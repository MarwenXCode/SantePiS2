...
public class NavigationDrawerFXMLController implements Initializable {
    ...
    Parent parent123 = FXMLLoader.load(getClass().getResource("/santepis2/gui/UpdateProfile.fxml"));
    ...
    void about(ActionEvent event) throws IOException {
        Parent parent1236 = FXMLLoader.load(getClass().getResource("/santepis2/gui/FXMLhomeDocument.fxml"));
